...
<html lang="vi">
   <head>
     ...
     <a href="{{route('home')}}"><link rel="shortcut icon" href="https://www.pngkey.com/png/detail/360-3601772_your-logo-here-your-company-logo-here-png.png" type="image/x-icon" /></a> 
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        <li class="current-menu-item active"><a title="Trang Chủ" href="{{route('home1')}}">Trang Chủ</a></li>
                        @foreach($category as $item)
                        <li class="mega"><a title="Phim Mới" href="{{route('category',$item->slug)}}">{{$item->title}}</a></li>
                        @endforeach
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="Tâm Lý" href="{{route('genre',$item->slug)}}">{{$item->title}}</a></li>
                              @endforeach
                           </ul>
                        </li>
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="Việt nam" href="{{route('country',$item->slug)}}">{{$item->title}}</a></li>
                              @endforeach
                           </ul>
                        </li>
